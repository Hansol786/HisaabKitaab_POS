...
<head>
    ...
    <link href="{{ asset('dashboard') }}/css/bootstrap-dark.min.css" rel="stylesheet" type="text/css"
        id="bs-dark-stylesheet" />
    <link href="{{ asset('dashboard') }}/css/app-dark.min.css" rel="stylesheet" type="text/css"
