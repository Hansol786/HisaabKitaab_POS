...
<!-- Mirrored from coderthemes.com/codefox/layouts/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Oct 2022 18:55:53 GMT -->
<head>
        <meta charset="utf-8" />
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Already have account?  <a href="auth-login.html" class="link-dark text-decoration-underline ms-1"><b>Sign In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
