                ...
                <div class="widget-rounded-circle card bg-purple shadow-none">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="text-end">
                                    <h2 class="text-white mt-2">$<span data-plugin="counterup">847</span></h2>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="text-end">
                                    <h2 class="text-white mt-2">$<span data-plugin="counterup">847</span></h2>
                                    <p class="text-white mb-0 text-truncate">Today Sales</p>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="text-end">
                                    <h2 class="text-white mt-2">$<span data-plugin="counterup">847</span></h2>
                                    <p class="text-white mb-0 text-truncate">Today Sales Recevied</p>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="text-end">
                                    <h2 class="text-white mt-2">$<span data-plugin="counterup">847</span></h2>
                                    <p class="text-white mb-0 text-truncate">Sale Returns</p>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="text-end">
                                    <h2 class="text-white mt-2">$<span data-plugin="counterup">847</span></h2>
                                    <p class="text-white mb-0 text-truncate">Purchases</p>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="text-end">
                                    ...
                                    <p class="text-white mb-0 text-truncate">Today Purchases</p>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="text-end">
                                    <h2 class="text-white mt-2">$<span data-plugin="counterup">847</span></h2>
                                    <p class="text-white mb-0 text-truncate">Purchase Returns</p>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="text-end">
                                    ...
                                    <p class="text-white mb-0 text-truncate">Today Expenses</p>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div>
                            ...
                            <div class="row align-items-center mt-2">
                                <div class="col-xl-5">
                                    <h5>Multisite <span class="text-muted fw-normal"> - Unlimited
                                            sites</span> <b class="px-2">-</b> <span
                                            class="text-muted">60%</span></h5>
                                </div>
                                <div class="col-xl-7">
                                    <div class="progress" style="height: 6px;">
                            ...
                            <div class="row align-items-center mt-2">
                                <div class="col-xl-5">
                                    <h5>Extended <span class="text-muted fw-normal"> - For paying
                                            users</span> <b class="px-2">-</b> <span
                                            class="text-muted">85%</span></h5>
                                </div>
                                <div class="col-xl-7">
                                    <div class="progress" style="height: 6px;">
                                    ...
                                    <div class="col-6 offset-1">
                                        <div class="text-end">
                                            ...
                                            <h5 class="mb-0 text-success"><i
                                                    class="mdi mdi-trending-up font-18 me-1"></i>20.7%</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <a href="#" class="text-primary float-end"><i
                                    class="mdi mdi-arrow-right font-20"></i></a>
                            <span
                                class="bg-soft-pink fw-medium text-pink rounded px-2 font-12 py-1">Excellent</span>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-hover table-centered mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>82</td>
                                        <td><span
                                                class="badge text-success border border-success">Active</span>
                                        </td>
                                        <td>$6,518.18</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>37</td>
                                        <td><span
                                                class="badge text-warning border border-warning">Pending</span>
                                        </td>
                                        <td>$4,754.50</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>64</td>
                                        <td><span
                                                class="badge text-primary border border-primary">Done</span>
                                        </td>
                                        <td>$2,559.36</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="align-items-center border-bottom border-light py-2 my-1">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar-md rounded-circle bg-soft-pink">
                                    <i
                                        class="mdi mdi-emoticon-happy-outline font-26 avatar-title text-pink"></i>
                                </div>
