        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Base Units</h4>
                    <div>
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Base Units</a></li>
                            <li class="breadcrumb-item active">Base Units List</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-1">
                            <div class="col-md-6">
                                <h4 class="header-title">Base Units</h4>
                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Add Base Unit</h4>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-info waves-effect waves-light">Add Base Unit</button>
                    </div>
                </div>
            </div>
            </div><!-- /.modal -->
